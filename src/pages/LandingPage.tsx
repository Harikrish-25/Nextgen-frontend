          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-6xl font-extrabold text-gray-800 leading-tight tracking-tight">
                  Nourish Your Body,
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  ...
                  className="border-2 border-teal-600 text-teal-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-teal-600 hover:text-white transition-all duration-300 flex items-center justify-center"
                >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-800 mb-4 tracking-tight">Our Impact</h2>
            <p className="text-lg text-gray-500">Making a difference in communities and lives</p>
          </div>
      ...
      <section className="py-16 bg-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">Stay Updated</h2>
            <p className="text-lg text-teal-100 mb-8">Get the latest news on health, wellness, and our new products</p>
